(ns emmy-clerk-demo.sci-extensions
    (:require [emmy-clerk-demo.custom]
              [emmy.sci]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns emmy-clerk-demo.custom
               (sci/create-ns 'emmy-clerk-demo.custom)))
...
(def custom-namespaces
  {'emmy-clerk-demo.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [emmy-clerk-demo.custom :as custom])`
(def custom-aliases
  {'custom 'emmy-clerk-demo.custom})
