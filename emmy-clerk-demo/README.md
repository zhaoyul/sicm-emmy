...
`notebooks/emmy_clerk_demo/emmy_clerk_demo.clj`.
...
ClojureScript build. See `dev/emmy_clerk_demo/sci_extensions.cljs` for more
information.
...
```clj
(clerk/show! "notebooks/emmy_clerk_demo/emmy_clerk_demo.clj")
```
...
All ClojureScript code you add to `src/emmy_clerk_demo/custom.cljs` is available
for use inside any [custom viewer code you
write](https://book.clerk.vision/#writing-viewers).

This is made possible by the code in `src/emmy_clerk_demo/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `emmy-clerk-demo` and the project name is `emmy-clerk-demo`.
...
git branch -M main
git remote add origin git@github.com:emmy-clerk-demo.git
git push -u origin main
```

Then visit https://github.com/emmy-clerk-demo to see your site.
...
By default your site will live at https://emmy-clerk-demo.github.io/emmy-clerk-demo.
...
https://github.clerk.garden/emmy-clerk-demo
